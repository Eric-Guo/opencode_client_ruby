...
module OpencodeClient
  class ConfigExperimental < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if !@mcp_timeout.nil? && @mcp_timeout <= 0
        invalid_properties.push('invalid value for "mcp_timeout", must be greater than 0.')
      end
    ...
    def valid?
      ...
      return false if !@mcp_timeout.nil? && @mcp_timeout <= 0
      true
    end
    ...
    def mcp_timeout=(mcp_timeout)
      ...
      if mcp_timeout <= 0
        fail ArgumentError, 'invalid value for "mcp_timeout", must be greater than 0.'
      end
    ...
    def hash
      [disable_paste_summary, batch_tool, open_telemetry, primary_tools, continue_loop_on_deny, mcp_timeout].hash
    end
