...
module OpencodeClient
  class File < ApiModelBase
    ...
    def added=(added)
      ...
      if added > 9007199254740991
        fail ArgumentError, 'invalid value for "added", must be smaller than or equal to 9007199254740991.'
      end

      if added < -9007199254740991
        fail ArgumentError, 'invalid value for "added", must be greater than or equal to -9007199254740991.'
      end
    ...
    def removed=(removed)
      ...
      if removed > 9007199254740991
        fail ArgumentError, 'invalid value for "removed", must be smaller than or equal to 9007199254740991.'
      end

      if removed < -9007199254740991
        fail ArgumentError, 'invalid value for "removed", must be greater than or equal to -9007199254740991.'
      end
