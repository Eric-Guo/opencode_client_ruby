...
module OpencodeClient
  class AssistantMessage < ApiModelBase
    ...
    def valid?
      ...
      return false if @id !~ Regexp.new(/^msg.*/)
      ...
      return false if @parent_id !~ Regexp.new(/^msg.*/)
    ...
    def hash
      [id, session_id, role, time, error, parent_id, model_id, provider_id, mode, agent, path, summary, cost, tokens, structured, variant, finish].hash
    end
