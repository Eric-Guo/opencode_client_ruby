...
module OpencodeClient
  class ProviderConfigModelsValue < ApiModelBase
    ...
    def hash
      [id, name, family, release_date, attachment, reasoning, temperature, tool_call, interleaved, cost, limit, modalities, experimental, status, provider, options, headers, variants].hash
    end
